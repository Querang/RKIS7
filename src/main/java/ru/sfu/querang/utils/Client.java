...
public class Client implements CommandLineRunner {
    ...
    public void showAll() {
        ...
        carsMono
                .doOnSuccess(cars -> log("All notes:\n" + cars.stream()
                        .map(car -> {
                            ids.add(car.getId());
    ...
    public void showOne(int id) {
        ...
        carMono
                .doOnSuccess(car -> log("Note id = " + id + ": " + car, "Client"))
                .subscribeOn(Schedulers.boundedElastic())
                .block();
    }
    ...
    public void showFilteredByPrice(Float price) {
        ...
        carsMono
                .doOnSuccess(cars -> log("Note with max price " + price + " :\n" + cars.stream()
                        .map(Object::toString)
                        .collect(Collectors.joining("\n")), "Client"))
                .subscribeOn(Schedulers.boundedElastic())
                .block();
    ...
    public void updateCar(int id) {
        ...
        log(String.format("Update car id = %d на ", id) + car, "Client");
